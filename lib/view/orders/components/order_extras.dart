                      ...
                      Column(
                          ...
                          children: [
                            ...
                            CommonHelper().paragraphCommon(
                                '${ln.getString("Unit price")}: \$${provider.orderExtra[i].price.toStringAsFixed(2)}    Quantity: ${provider.orderExtra[i].quantity}',
                                TextAlign.left),
                            const SizedBox(
                              height: 4,
                            ),
                            CommonHelper().paragraphCommon(
                                '${ln.getString("Total")}: \$${provider.orderExtra[i].total.toStringAsFixed(2)}',
                                TextAlign.left),
                            sizedBoxCustom(20),
                          ])
                  ],

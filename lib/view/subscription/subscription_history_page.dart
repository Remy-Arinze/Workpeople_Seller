                                          ...
                                          child: Column(
                                              ...
                                              children: [
                                                CommonHelper().titleCommon(
                                                    '${provider.subsHistoryList[i].type} ${ln.getString('subscription')}',
                                                    fontsize: 15),
                                                sizedBoxCustom(8),
                                                Text(
                                                  "${ln.getString('Start date')}: ${formatDate(provider.subsHistoryList[i].createdAt)}",
                                                  style: TextStyle(
                                                    color: cc.greyFour,
                                                    fontSize: 14,
                                                    height: 1.4,
                                                ...
                                                sizedBoxCustom(6),
                                                Text(
                                                  "${ln.getString('Expire date')}: ${formatDate(provider.subsHistoryList[i].expireDate)}",
                                                  style: TextStyle(
                                                    color: cc.greyFour,
                                                    fontSize: 14,
                                                    height: 1.4,
